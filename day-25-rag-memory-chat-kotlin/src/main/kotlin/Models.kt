...
data class ChatSession(
    ...
    val taskState: TaskStateMemory = TaskStateMemory(),
    val history: List<ChatTurn> = emptyList(),
)

data class ChatTurnRun(
    val mode: String,
    val userMessage: String,
    val retrievalQuery: String,
    val taskStateBefore: TaskStateMemory,
    val taskStateAfter: TaskStateMemory,
    val groundedRun: GroundedRun,
...
data class ChatScenarioStep(
    val user: String,
    val expectSources: Boolean = true,
)
...
data class ChatScenario(
    val id: String,
    val title: String,
    val expectedGoalTerms: List<String>,
    val expectedConstraintTerms: List<String> = emptyList(),
    val expectedTerms: List<String> = emptyList(),
    val steps: List<ChatScenarioStep>,
)

@Serializable
data class ScenarioStepRecord(
    val turn: Int,
    val user: String,
    val status: String,
    val sourcesPresent: Boolean,
    val quotesMatchChunks: Boolean,
    val ragCalled: Boolean,
...
@Serializable
data class ScenarioEvaluationRecord(
    val id: String,
    val title: String,
    val turnCount: Int,
    val answersWithSources: Int,
    val quotesMatchChunks: Int,
    val ragCalls: Int,
    val goalRetained: Boolean,
    val constraintsRetained: Boolean,
    val termsRetained: Boolean,
    val finalTaskState: TaskStateMemory,
    val records: List<ScenarioStepRecord>,
)

@Serializable
data class ScenarioEvaluationReport(
    val generatedAtIso: String,
    val mode: String,
    ...
    val quotesMatchChunks: Int,
    val ragCalls: Int,
    val goalsRetained: Int,
    val constraintsRetained: Int,
    val termsRetained: Int,
    val records: List<ScenarioEvaluationRecord>,
)
