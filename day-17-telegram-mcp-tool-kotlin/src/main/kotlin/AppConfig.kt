    ...
    companion object {
        fun load(): AppConfig {
            ...
            return AppConfig(
                ...
                serverPort = env["MCP_SERVER_PORT"]?.toIntOrNull() ?: 3017,
                clientName = env["MCP_CLIENT_NAME"] ?: "ai-course-day-17-agent",
                ...
                telegramQrWaitSeconds = env["TELEGRAM_QR_WAIT_SECONDS"]?.toLongOrNull() ?: 180L,
