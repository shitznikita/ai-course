...
- Days 26-30 use local Ollama through a loopback-only HTTP API. Day 30 targets a CPU VPS with `qwen3:4b`, Tesseract OCR, strict JSON, local evidence IDs and bounded chat.
