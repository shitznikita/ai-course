...
data class AppConfig(
    ...
    val stateFile: Path,
    val factsUpdateMode: String,
    val debug: Boolean,
    val inputPricePerMillionTokens: Double?,
    val outputPricePerMillionTokens: Double?,
) {
    companion object {
        fun fromEnv(env: Map<String, String>, mode: String): AppConfig {
            ...
            return AppConfig(
                ...
                recentMessagesLimit = env["RECENT_MESSAGES_LIMIT"]?.toIntOrNull() ?: 6,
                stateFile = Path.of(env["CONTEXT_STATE_FILE"] ?: "context-state.json"),
                factsUpdateMode = env["FACTS_UPDATE_MODE"] ?: "llm",
