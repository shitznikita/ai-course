...
export RECENT_MESSAGES_LIMIT="${RECENT_MESSAGES_LIMIT:-6}"
export CONTEXT_STATE_FILE="${CONTEXT_STATE_FILE:-context-state.json}"
export FACTS_UPDATE_MODE="${FACTS_UPDATE_MODE:-llm}"
...
exec ./gradlew \
    ...
    :day-10-context-strategies-kotlin:run \
    "$@"
