...
export MCP_SERVER_PORT="${MCP_SERVER_PORT:-3018}"
export MCP_CLIENT_NAME="${MCP_CLIENT_NAME:-ai-course-day-18-scheduler-agent}"
...
export SCHEDULE_TIME="${SCHEDULE_TIME:-13:00}"
export SCHEDULE_ZONE="${SCHEDULE_ZONE:-Europe/Moscow}"
export SCHEDULE_INTERVAL_SECONDS="${SCHEDULE_INTERVAL_SECONDS:-30}"
export SCHEDULER_RUNS="${SCHEDULER_RUNS:-2}"
...
cd "$ROOT_DIR"
GRADLE_ARGS=("${TRUST_STORE_ARGS[@]}" ":day-18-telegram-course-scheduler-kotlin:run")
