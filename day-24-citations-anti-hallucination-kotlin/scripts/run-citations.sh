...
export UNKNOWN_QUESTIONS_FILE="${UNKNOWN_QUESTIONS_FILE:-eval/unknown-questions.json}"
...
cd "$ROOT_DIR"
GRADLE_ARGS=("${TRUST_STORE_ARGS[@]}" ":day-24-citations-anti-hallucination-kotlin:run")
