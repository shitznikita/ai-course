...
data class AppConfig(
    ...
    val stateDir: Path,
    val pipelineRequest: String,
    val pipelineMaxSteps: Int,
    ...
    companion object {
        fun load(): AppConfig {
            ...
            return AppConfig(
                ...
                serverPort = env["MCP_SERVER_PORT"]?.toIntOrNull() ?: 3019,
                clientName = env["MCP_CLIENT_NAME"] ?: "ai-course-day-19-pipeline-agent",
                ...
                pipelineRequest = env["PIPELINE_REQUEST"]?.blankToNull()
                    ?: "Найди обсуждение задания дня курса в Telegram, сделай итог и execution prompt, затем сохрани результат в файл.",
                pipelineMaxSteps = env["PIPELINE_MAX_STEPS"]?.toIntOrNull()?.coerceIn(3, 8) ?: 3,
