...
include("day-20-mcp-orchestration-kotlin")
include("day-21-document-indexing-kotlin")
include("day-22-first-rag-query-kotlin")
include("day-23-reranking-filtering-kotlin")
include("day-24-citations-anti-hallucination-kotlin")
include("day-25-rag-memory-chat-kotlin")
include("day-26-local-llm-kotlin")
include("day-27-local-notes-web-kotlin")
include("day-28-local-rag-kotlin")
include("day-29-local-llm-optimization-kotlin")
include("day-30-private-cosmetics-service-kotlin")
include("day-31-developer-assistant-kotlin")
include("day-32-ai-code-review-kotlin")
include("day-33-support-assistant-kotlin")
include("day-34-project-file-assistant-kotlin")
include("day-35-ai-release-prep-kotlin")
